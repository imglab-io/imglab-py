...
class TestUrlWithSource(unittest.TestCase):
    def test_url_without_params(self):
        url = imglab.url(imglab.Source("assets"), "example.jpeg")
    ...
    def test_url_with_params_using_names_with_underscores(self):
        url = imglab.url(imglab.Source("assets"), "example.jpeg", trim="color", trim_color="orange")
    ...
    def test_url_with_params_using_dict_keys_with_hyphens(self):
        url = imglab.url(imglab.Source("assets"), "example.jpeg", **{"trim": "color", "trim-color": "orange"})

        self.assertEqual(url, "https://assets.imglab-cdn.net/example.jpeg?trim=color&trim-color=orange")

    def test_url_with_expires_param_using_a_struct_time(self):
        url = imglab.url(imglab.Source("assets"), "example.jpeg", width=200, height=300, expires=gmtime(1464096368))

        self.assertEqual(url, "https://assets.imglab-cdn.net/example.jpeg?width=200&height=300&expires=1464096368")

    def test_url_with_expires_param_using_a_datetime(self):
        url = imglab.url(imglab.Source("assets"), "example.jpeg", width=200, height=300, expires=datetime.fromtimestamp(1464096368))
    ...
    def test_url_with_path_starting_with_slash_using_reserved_characters(self):
        url = imglab.url(imglab.Source("assets"), "/example image%2C01%2C02.jpeg", width=200, height=300, format="png")
    ...
    def test_url_with_subfolder_path_starting_with_slash(self):
        url = imglab.url(imglab.Source("assets"), "/subfolder/example.jpeg", width=200, height=300, format="png")
    ...
    def test_url_with_path_using_http_url(self):
        url = imglab.url(imglab.Source("assets"), "http://assets.com/subfolder/example.jpeg", width=200, height=300, format="png")
    ...
    def test_url_with_path_using_https_url(self):
        url = imglab.url(imglab.Source("assets"), "https://assets.com/subfolder/example.jpeg", width=200, height=300, format="png")
...
class TestUrlWithSecureSource(unittest.TestCase):
    ...
    def test_url_without_params(self):
        url = imglab.url(imglab.Source("assets", secure_key=self.SECURE_KEY, secure_salt=self.SECURE_SALT), "example.jpeg")
    ...
    def test_url_with_params_using_url_with_source(self):
        source = imglab.Source("assets", secure_key=self.SECURE_KEY, secure_salt=self.SECURE_SALT)
    ...
    def test_url_with_params_using_dict(self):
        url = imglab.url(imglab.Source("assets", secure_key=self.SECURE_KEY, secure_salt=self.SECURE_SALT), "example.jpeg", **{"width": 200, "height": 300, "format": "png"})

        self.assertEqual(url, "https://assets.imglab-cdn.net/example.jpeg?width=200&height=300&format=png&signature=VJ159IlBl_AlN59QWvyJov5SlQXlrZNpXgDJLJgzP8g")

    def test_url_with_params_using_dict_keys_with_underscores(self):
        url = imglab.url(imglab.Source("assets", secure_key=self.SECURE_KEY, secure_salt=self.SECURE_SALT), "example.jpeg", **{"trim": "color", "trim_color": "orange"})

        self.assertEqual(url, "https://assets.imglab-cdn.net/example.jpeg?trim=color&trim-color=orange&signature=cfYzBKvaWJhg_4ArtL5IafGYU6FEgRb_5ZADIgvviWw")

    def test_url_with_params_using_dict_keys_with_hyphens(self):
        url = imglab.url(imglab.Source("assets", secure_key=self.SECURE_KEY, secure_salt=self.SECURE_SALT), "example.jpeg", **{"trim": "color", "trim-color": "orange"})
    ...
    def test_url_with_expires_param_using_a_datetime(self):
        url = imglab.url(
            ...
            width=200,
            height=300,
            expires=datetime.fromtimestamp(1464096368),
        )
