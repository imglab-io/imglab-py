...
class TestSrcsetWithSourceName(unittest.TestCase):
    ...
    def test_srcset_without_size_params(self):
    ...
    def test_srcset_with_none_width(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=None)
    ...
    def test_srcset_with_none_height(self):
        srcset = imglab.srcset("assets", "example.jpeg", height=None)
    ...
    def test_srcset_without_widht_without_height_and_with_fixed_quality(self):
    ...
    def test_srcset_without_width_without_height_and_with_none_quality(self):
        srcset = imglab.srcset("assets", "example.jpeg", quality=None)
    ...
    def test_srcset_without_width_without_height_and_with_range_of_qualities(self):
        srcset = imglab.srcset("assets", "example.jpeg", quality=range(75, 40))
    ...
    def test_srcset_without_width_without_height_and_with_empty_list_of_qualities(self):
    ...
    def test_srcset_without_width_without_height_and_with_list_of_qualities_of_size_1(self):
        srcset = imglab.srcset("assets", "example.jpeg", quality=[75])
    ...
    def test_srcset_without_width_without_height_and_with_list_of_qualities(self):
    ...
    def test_srcset_with_fixed_width(self):
    ...
    def test_srcset_with_fixed_width_and_fixed_dpr(self):
    ...
    def test_srcset_with_fixed_width_and_none_dpr(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=200, dpr=None)
    ...
    def test_srcset_with_fixed_width_and_range_of_dprs(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=200, dpr=range(1, 4))
    ...
    def test_srcset_with_fixed_width_and_empty_list_of_dprs(self):
    ...
    def test_srcset_with_fixed_width_and_list_of_dprs_of_size_1(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=200, dpr=[1])

        self.assertEqual(srcset, "https://assets.imglab-cdn.net/example.jpeg?width=200&dpr=1 1x")

    def test_srcset_with_fixed_width_and_list_of_dprs(self):
    ...
    def test_srcset_with_fixed_width_and_fixed_quality(self):
    ...
    def test_srcset_with_fixed_width_and_none_quality(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=200, quality=None)
    ...
    def test_srcset_with_fixed_width_and_range_of_qualities(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=200, quality=range(75, 40))
    ...
    def test_srcset_with_fixed_width_and_empty_list_of_qualities(self):
    ...
    def test_srcset_with_fixed_width_and_list_of_qualities_of_size_1(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=200, quality=[75])
    ...
    def test_srcset_with_fixed_width_and_list_of_qualities(self):
    ...
    def test_srcset_with_fixed_width_range_of_dprs_and_range_of_qualities(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=200, dpr=range(1, 4), quality=range(75, 40))
    ...
    def test_srcset_with_fixed_width_list_of_dprs_and_list_of_qualities(self):
    ...
    def test_srcset_with_fixed_height(self):
    ...
    def test_srcset_with_fixed_height_and_fixed_dpr(self):
    ...
    def test_srcset_with_fixed_height_and_none_dpr(self):
        srcset = imglab.srcset("assets", "example.jpeg", height=200, dpr=None)
    ...
    def test_srcset_with_fixed_height_and_range_of_dprs(self):
        srcset = imglab.srcset("assets", "example.jpeg", height=200, dpr=range(1, 4))
    ...
    def test_srcset_with_fixed_height_and_empty_list_of_dprs(self):
    ...
    def test_srcset_with_fixed_height_and_list_of_dprs_of_size_1(self):
        srcset = imglab.srcset("assets", "example.jpeg", height=200, dpr=[1])

        self.assertEqual(srcset, "https://assets.imglab-cdn.net/example.jpeg?height=200&dpr=1 1x")

    def test_srcset_with_fixed_height_and_list_of_dprs(self):
    ...
    def test_srcset_with_fixed_height_and_fixed_quality(self):
    ...
    def test_srcset_with_fixed_height_and_none_quality(self):
        srcset = imglab.srcset("assets", "example.jpeg", height=200, quality=None)
    ...
    def test_srcset_with_fixed_height_and_range_of_qualities(self):
        srcset = imglab.srcset("assets", "example.jpeg", height=200, quality=range(75, 40))
    ...
    def test_srcset_with_fixed_height_and_empty_list_of_qualities(self):
    ...
    def test_srcset_with_fixed_height_and_list_of_qualities_of_size_1(self):
        srcset = imglab.srcset("assets", "example.jpeg", height=200, quality=[75])
    ...
    def test_srcset_with_fixed_height_and_list_of_qualities(self):
    ...
    def test_srcset_with_fixed_height_range_of_dprs_and_range_of_qualities(self):
        srcset = imglab.srcset("assets", "example.jpeg", height=200, dpr=range(1, 4), quality=range(75, 40))
    ...
    def test_srcset_with_fixed_height_list_of_dprs_and_list_of_qualities(self):
    ...
    def test_srcset_with_fixed_width_and_fixed_height(self):
    ...
    def test_srcset_with_fixed_width_fixed_height_and_fixed_dpr(self):
    ...
    def test_srcset_with_fixed_width_fixed_height_and_range_of_dprs(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=200, height=300, dpr=range(1, 4))
    ...
    def test_srcset_with_fixed_width_fixed_height_and_empty_list_of_dprs(self):
    ...
    def test_srcset_with_fixed_width_fixed_height_and_list_of_dprs_of_size_1(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=200, height=300, dpr=[1])

        self.assertEqual(srcset, "https://assets.imglab-cdn.net/example.jpeg?width=200&height=300&dpr=1 1x")

    def test_srcset_with_fixed_width_fixed_height_and_list_of_dprs(self):
    ...
    def test_srcset_with_fixed_width_fixed_height_and_fixed_quality(self):
    ...
    def test_srcset_with_fixed_width_fixed_height_and_range_of_qualities(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=200, height=300, quality=range(75, 40))
    ...
    def test_srcset_with_fixed_width_fixed_height_empty_list_of_qualities(self):
    ...
    def test_srcset_with_fixed_width_fixed_height_and_list_of_qualities_of_size_1(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=200, height=300, quality=[75])
    ...
    def test_srcset_with_fixed_width_fixed_height_and_list_of_qualities(self):
    ...
    def test_srcset_with_fixed_width_fixed_height_range_of_dprs_and_range_of_qualities(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=200, height=300, dpr=range(1, 4), quality=range(75, 40))
    ...
    def test_returns_srcset_with_fixed_width_fixed_height_list_of_dprs_and_list_of_qualities(self):
    ...
    def test_srcset_with_range_of_widths(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=range(100, 4096))
    ...
    def test_srcset_with_range_of_widths_and_range_of_qualities(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=range(100, 4096), quality=range(70, 40))
    ...
    def test_srcset_with_sequence_of_widths(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=imglab.sequence(100, 4096, 6))
    ...
    def test_srcset_with_sequence_of_widths_and_range_of_qualities(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=imglab.sequence(100, 4096, 6), quality=range(70, 40))
    ...
    def test_srcset_with_empty_list_of_widths(self):
    ...
    def test_srcset_with_list_of_widths_of_size_1(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=[200])

        self.assertEqual(srcset, "https://assets.imglab-cdn.net/example.jpeg?width=200 200w")

    def test_srcset_with_list_of_widths(self):
    ...
    def test_srcset_with_list_of_widths_and_range_of_heights(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=[200, 300, 400], height=range(300, 500))
    ...
    def test_srcset_with_list_of_widths_and_empty_list_of_heights(self):
    ...
    def test_srcset_with_list_of_widths_and_list_of_heights_of_size_1(self):
    ...
    def test_srcset_with_list_of_widths_and_list_of_heights(self):
    ...
    def test_srcset_with_list_of_widths_and_range_of_qualities(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=[200, 300, 400], quality=range(75, 40))
    ...
    def test_srcset_with_list_of_widths_and_empty_list_of_qualities(self):
    ...
    def test_srcset_with_list_of_widths_and_list_of_qualities_of_size_1(self):
    ...
    def test_srcset_with_list_of_widths_and_list_of_qualities(self):
    ...
    def test_srcset_with_list_of_widths_range_of_heights_and_range_of_qualities(self):
        srcset = imglab.srcset("assets", "example.jpeg", width=[200, 300, 400], height=range(300, 500), quality=range(75, 40))
    ...
    def test_srcset_with_list_of_widths_list_of_heights_and_list_of_qualities(self):
    ...
    def test_raises_a_value_error_when_width_is_fluid_and_dpr_is_also_fluid(self):
        with self.assertRaises(ValueError): imglab.srcset("assets", "example.jpeg", width=range(100, 300), dpr=range(1, 3))
        with self.assertRaises(ValueError): imglab.srcset("assets", "example.jpeg", width=range(100, 300), dpr=[1, 2, 3])
        with self.assertRaises(ValueError): imglab.srcset("assets", "example.jpeg", width=[100, 200, 300], dpr=range(1, 3))
        with self.assertRaises(ValueError): imglab.srcset("assets", "example.jpeg", width=[100, 200, 300], dpr=[1, 2, 3])
        with self.assertRaises(ValueError): imglab.srcset("assets", "example.jpeg", width=imglab.sequence(100, 300), dpr=range(1, 3))
        with self.assertRaises(ValueError): imglab.srcset("assets", "example.jpeg", width=imglab.sequence(100, 300), dpr=[1, 2, 3])

    def test_raises_a_value_error_when_width_is_fixed_and_height_is_fluid(self):
        with self.assertRaises(ValueError): imglab.srcset("assets", "example.jpeg", height=range(100, 300))
        with self.assertRaises(ValueError): imglab.srcset("assets", "example.jpeg", height=[100, 200, 300])
        with self.assertRaises(ValueError): imglab.srcset("assets", "example.jpeg", width=100, height=range(100, 300))
        with self.assertRaises(ValueError): imglab.srcset("assets", "example.jpeg", width=100, height=[100, 200, 300])

    def test_raises_a_value_error_when_width_and_height_are_not_specified_and_dpr_is_fluid(self):
        with self.assertRaises(ValueError): imglab.srcset("assets", "example.jpeg", dpr=range(1, 3))
        with self.assertRaises(ValueError): imglab.srcset("assets", "example.jpeg", dpr=[1, 2, 3])


class TestSrcsetWithSource(unittest.TestCase):
    def setUp(self):
    ...
    def test_srcset_without_size_params(self):
        srcset = imglab.srcset(self.source, "example.jpeg", aspect_ratio="16:9", format="png")
    ...
    def test_srcset_with_none_width(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=None)
    ...
    def test_srcset_with_none_height(self):
        srcset = imglab.srcset(self.source, "example.jpeg", height=None)
    ...
    def test_srcset_without_widht_without_height_and_with_fixed_quality(self):
        srcset = imglab.srcset(self.source, "example.jpeg", quality=75)
    ...
    def test_srcset_without_width_without_height_and_with_none_quality(self):
        srcset = imglab.srcset(self.source, "example.jpeg", quality=None)
    ...
    def test_srcset_without_width_without_height_and_with_range_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", quality=range(75, 40))
    ...
    def test_srcset_without_width_without_height_and_with_empty_list_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", quality=[])
    ...
    def test_srcset_without_width_without_height_and_with_list_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", quality=[75, 70, 65])
    ...
    def test_srcset_with_fixed_width(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200)
    ...
    def test_srcset_with_fixed_width_and_fixed_dpr(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, dpr=2)
    ...
    def test_srcset_with_fixed_width_and_none_dpr(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, dpr=None)
    ...
    def test_srcset_with_fixed_width_and_range_of_dprs(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, dpr=range(1, 4))
    ...
    def test_srcset_with_fixed_width_and_empty_list_of_dprs(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, dpr=[])
    ...
    def test_srcset_with_fixed_width_and_list_of_dprs_of_size_1(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, dpr=[1])

        self.assertEqual(srcset, "https://assets.imglab-cdn.net/example.jpeg?width=200&dpr=1 1x")

    def test_srcset_with_fixed_width_and_list_of_dprs(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, dpr=[1, 2, 3])
    ...
    def test_srcset_with_fixed_width_and_fixed_quality(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, quality=75)
    ...
    def test_srcset_with_fixed_width_and_none_quality(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, quality=None)
    ...
    def test_srcset_with_fixed_width_and_range_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, quality=range(75, 40))
    ...
    def test_srcset_with_fixed_width_and_empty_list_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, quality=[])
    ...
    def test_srcset_with_fixed_width_and_list_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, quality=[75, 70, 65])
    ...
    def test_srcset_with_fixed_width_range_of_dprs_and_range_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, dpr=range(1, 4), quality=range(75, 40))
    ...
    def test_srcset_with_fixed_width_list_of_dprs_and_list_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, dpr=[1, 2, 3], quality=[75, 70, 65])
    ...
    def test_srcset_with_fixed_height(self):
        srcset = imglab.srcset(self.source, "example.jpeg", height=200)
    ...
    def test_srcset_with_fixed_height_and_fixed_dpr(self):
        srcset = imglab.srcset(self.source, "example.jpeg", height=200, dpr=2)
    ...
    def test_srcset_with_fixed_height_and_none_dpr(self):
        srcset = imglab.srcset(self.source, "example.jpeg", height=200, dpr=None)
    ...
    def test_srcset_with_fixed_height_and_range_of_dprs(self):
        srcset = imglab.srcset(self.source, "example.jpeg", height=200, dpr=range(1, 4))
    ...
    def test_srcset_with_fixed_height_and_empty_list_of_dprs(self):
        srcset = imglab.srcset(self.source, "example.jpeg", height=200, dpr=[])
    ...
    def test_srcset_with_fixed_height_and_list_of_dprs_of_size_1(self):
        srcset = imglab.srcset(self.source, "example.jpeg", height=200, dpr=[1])

        self.assertEqual(srcset, "https://assets.imglab-cdn.net/example.jpeg?height=200&dpr=1 1x")

    def test_srcset_with_fixed_height_and_list_of_dprs(self):
        srcset = imglab.srcset(self.source, "example.jpeg", height=200, dpr=[1, 2, 3])
    ...
    def test_srcset_with_fixed_height_and_fixed_quality(self):
        srcset = imglab.srcset(self.source, "example.jpeg", height=200, quality=75)
    ...
    def test_srcset_with_fixed_height_and_none_quality(self):
        srcset = imglab.srcset(self.source, "example.jpeg", height=200, quality=None)
    ...
    def test_srcset_with_fixed_height_and_range_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", height=200, quality=range(75, 40))
    ...
    def test_srcset_with_fixed_height_and_empty_list_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", height=200, quality=[])
    ...
    def test_srcset_with_fixed_height_and_list_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", height=200, quality=[75, 70, 65])
    ...
    def test_srcset_with_fixed_height_range_of_dprs_and_range_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", height=200, dpr=range(1, 4), quality=range(75, 40))
    ...
    def test_srcset_with_fixed_height_list_of_dprs_and_list_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", height=200, dpr=[1, 2, 3], quality=[75, 70, 65])
    ...
    def test_srcset_with_fixed_width_and_fixed_height(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, height=300)
    ...
    def test_srcset_with_fixed_width_fixed_height_and_fixed_dpr(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, height=300, dpr=2)
    ...
    def test_srcset_with_fixed_width_fixed_height_and_range_of_dprs(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, height=300, dpr=range(1, 4))
    ...
    def test_srcset_with_fixed_width_fixed_height_and_empty_list_of_dprs(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, height=300, dpr=[])
    ...
    def test_srcset_with_fixed_width_fixed_height_and_list_of_dprs_of_size_1(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, height=300, dpr=[1])

        self.assertEqual(srcset, "https://assets.imglab-cdn.net/example.jpeg?width=200&height=300&dpr=1 1x")

    def test_srcset_with_fixed_width_fixed_height_and_list_of_dprs(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, height=300, dpr=[1, 2, 3])
    ...
    def test_srcset_with_fixed_width_fixed_height_and_fixed_quality(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, height=300, quality=75)
    ...
    def test_srcset_with_fixed_width_fixed_height_and_range_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, height=300, quality=range(75, 40))
    ...
    def test_srcset_with_fixed_width_fixed_height_empty_list_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, height=300, quality=[])
    ...
    def test_srcset_with_fixed_width_fixed_height_and_list_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, height=300, quality=[75, 70, 65])
    ...
    def test_srcset_with_fixed_width_fixed_height_range_of_dprs_and_range_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, height=300, dpr=range(1, 4), quality=range(75, 40))
    ...
    def test_returns_srcset_with_fixed_width_fixed_height_list_of_dprs_and_list_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=200, height=300, dpr=[1, 2, 3], quality=[75, 70, 65])
    ...
    def test_srcset_with_range_of_widths(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=range(100, 4096))
    ...
    def test_srcset_with_range_of_widths_and_range_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=range(100, 4096), quality=range(70, 40))
    ...
    def test_srcset_with_sequence_of_widths(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=imglab.sequence(100, 4096, 6))
    ...
    def test_srcset_with_sequence_of_widths_and_range_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=imglab.sequence(100, 4096, 6), quality=range(70, 40))
    ...
    def test_srcset_with_empty_list_of_widths(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=[])
    ...
    def test_srcset_with_list_of_widths(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=[200, 300, 400])
    ...
    def test_srcset_with_list_of_widths_and_range_of_heights(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=[200, 300, 400], height=range(300, 500))
    ...
    def test_srcset_with_list_of_widths_and_empty_list_of_heights(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=[200, 300, 400], height=[])
    ...
    def test_srcset_with_list_of_widths_and_list_of_heights_of_size_1(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=[200, 300, 400], height=[300])
    ...
    def test_srcset_with_list_of_widths_and_list_of_heights(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=[200, 300, 400], height=[300, 400, 500])
    ...
    def test_srcset_with_list_of_widths_and_range_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=[200, 300, 400], quality=range(75, 40))
    ...
    def test_srcset_with_list_of_widths_and_empty_list_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=[200, 300, 400], quality=[])
    ...
    def test_srcset_with_list_of_widths_and_list_of_qualities_of_size_1(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=[200, 300, 400], quality=[75])
    ...
    def test_srcset_with_list_of_widths_and_list_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=[200, 300, 400], quality=[75, 70, 65])
    ...
    def test_srcset_with_list_of_widths_range_of_heights_and_range_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=[200, 300, 400], height=range(300, 500), quality=range(75, 40))
    ...
    def test_srcset_with_list_of_widths_list_of_heights_and_list_of_qualities(self):
        srcset = imglab.srcset(self.source, "example.jpeg", width=[200, 300, 400], height=[300, 400, 500], quality=[75, 70, 65])
    ...
    def test_raises_a_value_error_when_width_is_fluid_and_dpr_is_also_fluid(self):
        with self.assertRaises(ValueError): imglab.srcset(self.source, "example.jpeg", width=range(100, 300), dpr=range(1, 3))
        with self.assertRaises(ValueError): imglab.srcset(self.source, "example.jpeg", width=range(100, 300), dpr=[1, 2, 3])
        with self.assertRaises(ValueError): imglab.srcset(self.source, "example.jpeg", width=[100, 200, 300], dpr=range(1, 3))
        with self.assertRaises(ValueError): imglab.srcset(self.source, "example.jpeg", width=[100, 200, 300], dpr=[1, 2, 3])
        with self.assertRaises(ValueError): imglab.srcset(self.source, "example.jpeg", width=imglab.sequence(100, 300), dpr=range(1, 3))
        with self.assertRaises(ValueError): imglab.srcset(self.source, "example.jpeg", width=imglab.sequence(100, 300), dpr=[1, 2, 3])

    def test_raises_a_value_error_when_width_is_fixed_and_height_is_fluid(self):
        with self.assertRaises(ValueError): imglab.srcset(self.source, "example.jpeg", height=range(100, 300))
        with self.assertRaises(ValueError): imglab.srcset(self.source, "example.jpeg", height=[100, 200, 300])
        with self.assertRaises(ValueError): imglab.srcset(self.source, "example.jpeg", width=100, height=range(100, 300))
        with self.assertRaises(ValueError): imglab.srcset(self.source, "example.jpeg", width=100, height=[100, 200, 300])

    def test_raises_a_value_error_when_width_and_height_are_not_specified_and_dpr_is_fluid(self):
        with self.assertRaises(ValueError): imglab.srcset(self.source, "example.jpeg", dpr=range(1, 3))
        with self.assertRaises(ValueError): imglab.srcset(self.source, "example.jpeg", dpr=[1, 2, 3])
...
class TestSrcsetWithSecureSource(unittest.TestCase):
    ...
    def test_srcset_with_fixed_width_and_list_of_dprs_of_size_1(self):
        ...
        self.assertEqual(srcset, "https://assets.imglab-cdn.net/example.jpeg?width=200&dpr=1&signature=Dt2QjQRTGriKiEL8b4bd1oR0s4kk_YR-t5ip9FG_8r4 1x")
    ...
    def test_srcset_with_fixed_height_and_list_of_dprs_of_size_1(self):
        ...
        self.assertEqual(srcset, "https://assets.imglab-cdn.net/example.jpeg?height=200&dpr=1&signature=OPRYWD06ACeu6W8YXkZ87-swVGCl9hCk7bPLh_wn6Cw 1x")
    ...
    def test_srcset_with_fixed_width_fixed_height_and_list_of_dprs_of_size_1(self):
        ...
        self.assertEqual(srcset, "https://assets.imglab-cdn.net/example.jpeg?width=200&height=300&dpr=1&signature=IJM9kyvoH30hC2Xr0-FG9CZxYvDSy9MsZJBbs6Wm2kg 1x")
    ...
    def test_srcset_with_list_of_widths_of_size_1(self):
        ...
        self.assertEqual(srcset, "https://assets.imglab-cdn.net/example.jpeg?width=200&signature=oV-jpcwoz0-UdXsZCVCecPwJ3tb88vfb1lwM2nKfq60 200w")
...
class TestSrcsetWithInvalidSource(unittest.TestCase):
    def test_url_with_none_as_source(self):
        with self.assertRaises(ValueError): imglab.srcset(None, "example.jpeg")

    def test_url_with_dict_as_source(self):
        with self.assertRaises(ValueError): imglab.srcset({}, "example.jpeg")

    def test_url_with_integer_as_source(self):
        with self.assertRaises(ValueError): imglab.srcset(10, "example.jpeg")


def load_tests(loader, tests, ignore):
    tests.addTests(doctest.DocTestSuite("imglab.srcset"))
