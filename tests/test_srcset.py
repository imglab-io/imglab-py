...
class TestSrcsetWithSourceName(unittest.TestCase):
    ...
    def test_raises_a_value_error_when_width_is_fluid_and_dpr_is_also_fluid(self):
        with self.assertRaises(ValueError):
            imglab.srcset("assets", "example.jpeg", width=range(100, 300), dpr=range(1, 3))
        with self.assertRaises(ValueError):
            imglab.srcset("assets", "example.jpeg", width=range(100, 300), dpr=[1, 2, 3])
        with self.assertRaises(ValueError):
            imglab.srcset("assets", "example.jpeg", width=[100, 200, 300], dpr=range(1, 3))
        with self.assertRaises(ValueError):
            imglab.srcset("assets", "example.jpeg", width=[100, 200, 300], dpr=[1, 2, 3])
        with self.assertRaises(ValueError):
            imglab.srcset("assets", "example.jpeg", width=imglab.sequence(100, 300), dpr=range(1, 3))
        with self.assertRaises(ValueError):
            imglab.srcset("assets", "example.jpeg", width=imglab.sequence(100, 300), dpr=[1, 2, 3])

    def test_raises_a_value_error_when_width_is_fixed_and_height_is_fluid(self):
        with self.assertRaises(ValueError):
            imglab.srcset("assets", "example.jpeg", height=range(100, 300))
        with self.assertRaises(ValueError):
            imglab.srcset("assets", "example.jpeg", height=[100, 200, 300])
        with self.assertRaises(ValueError):
            imglab.srcset("assets", "example.jpeg", width=100, height=range(100, 300))
        with self.assertRaises(ValueError):
            imglab.srcset("assets", "example.jpeg", width=100, height=[100, 200, 300])

    def test_raises_a_value_error_when_width_and_height_are_not_specified_and_dpr_is_fluid(self):
        with self.assertRaises(ValueError):
            imglab.srcset("assets", "example.jpeg", dpr=range(1, 3))
        with self.assertRaises(ValueError):
            imglab.srcset("assets", "example.jpeg", dpr=[1, 2, 3])
...
class TestSrcsetWithSource(unittest.TestCase):
    ...
    def test_raises_a_value_error_when_width_is_fluid_and_dpr_is_also_fluid(self):
        with self.assertRaises(ValueError):
            imglab.srcset(self.source, "example.jpeg", width=range(100, 300), dpr=range(1, 3))
        with self.assertRaises(ValueError):
            imglab.srcset(self.source, "example.jpeg", width=range(100, 300), dpr=[1, 2, 3])
        with self.assertRaises(ValueError):
            imglab.srcset(self.source, "example.jpeg", width=[100, 200, 300], dpr=range(1, 3))
        with self.assertRaises(ValueError):
            imglab.srcset(self.source, "example.jpeg", width=[100, 200, 300], dpr=[1, 2, 3])
        with self.assertRaises(ValueError):
            imglab.srcset(self.source, "example.jpeg", width=imglab.sequence(100, 300), dpr=range(1, 3))
        with self.assertRaises(ValueError):
            imglab.srcset(self.source, "example.jpeg", width=imglab.sequence(100, 300), dpr=[1, 2, 3])

    def test_raises_a_value_error_when_width_is_fixed_and_height_is_fluid(self):
        with self.assertRaises(ValueError):
            imglab.srcset(self.source, "example.jpeg", height=range(100, 300))
        with self.assertRaises(ValueError):
            imglab.srcset(self.source, "example.jpeg", height=[100, 200, 300])
        with self.assertRaises(ValueError):
            imglab.srcset(self.source, "example.jpeg", width=100, height=range(100, 300))
        with self.assertRaises(ValueError):
            imglab.srcset(self.source, "example.jpeg", width=100, height=[100, 200, 300])

    def test_raises_a_value_error_when_width_and_height_are_not_specified_and_dpr_is_fluid(self):
        with self.assertRaises(ValueError):
            imglab.srcset(self.source, "example.jpeg", dpr=range(1, 3))
        with self.assertRaises(ValueError):
            imglab.srcset(self.source, "example.jpeg", dpr=[1, 2, 3])
...
class TestSrcsetWithInvalidSource(unittest.TestCase):
    def test_url_with_none_as_source(self):
        with self.assertRaises(ValueError):
            imglab.srcset(None, "example.jpeg")
